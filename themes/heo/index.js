...
const LayoutBase = props => {
  ...
  return (
    <div
      id='theme-heo'
      className={`${siteConfig('FONT_STYLE')} bg-[#f7f9fe] dark:bg-[#18171d] min-h-screen flex flex-col scroll-smooth`}>
      <Style />
      ...
      <main
        id='wrapper-outer'
        className={`flex-1 w-full ${maxWidth} mx-auto relative md:px-5`}>
        <div
          id='container-inner'
...
const LayoutSlug = props => {
  ...
  return (
    <>
      <div
      className={`article w-full ${fullWidth ? '' : 'xl:max-w-5xl'} ${hasCode ? 'xl:w-[73.15vw]' : ''}  bg-white dark:bg-[#18171d] dark:border-gray-600 lg:hover:shadow lg:border rounded-2xl lg:px-2 lg:py-4 `}>
        {/* 文章锁 */}
